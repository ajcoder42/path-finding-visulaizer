...
export default class PathfindingVisualizer extends Component {
  ...
  handleMouseDown(row, col) {
    if (this.state.topMessage !== "Algorithm") return;
  ...
  render() {
    ...
    let textBox = (
      <div className="textBox">
        ...
        <div className="buttonContainer">{button1_task}</div>
        <div className="buttonContainer">{button2_task}</div>
      </div>
    );
    ...
    return (
      <div className="pathfindingVisualizer">
        <div className="container">
          ...
          <p>
            Algorithms are weighted and guarantees the shortest path!{" "}
